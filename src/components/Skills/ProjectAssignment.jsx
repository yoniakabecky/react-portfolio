    ...
    <div>
      ...
      <div className="projectContainer">
        ...
        <ul className="projectLinks">
          ...
          <li className="red">
            <a
              href="https://github.com/yoniakabecky/Employees-Manager-React-Bootstrap"
      ...
      <div className="projectContainer">
        ...
        <ul className="projectLinks">
          ...
          <li className="red">
            <a
              href="https://github.com/yoniakabecky/assignment-react-and-redux"
              rel="noopener noreferrer"
              target="_blank"
              className="pageLink"
            >
      ...
      <ProjectFooter
        prev
        next
        prevLink={ROUTES.E_COMMERCE}
        nextLink={ROUTES.PORTFOLIO}
      />
    </div>
  );
};
