  ...
  return (
    <div>
      ...
      <div className="projectContainer">
        ...
        <p>
          Skill: ReactJS, Context, Material-UI, Contentful, Netlify(hosting),
          PayPal(payment)
        </p>
        ...
        <ul className="projectLinks">
          ...
          <li className="red">
            <a
              href="https://macrameshop37.netlify.com/"
          ...
          <li className="red">
            <a
              href="https://github.com/yoniakabecky/react-shopping-site"
              rel="noopener noreferrer"
              target="_blank"
              className="pageLink"
            >
